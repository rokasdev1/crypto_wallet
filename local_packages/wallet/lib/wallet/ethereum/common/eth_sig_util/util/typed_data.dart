...
import 'package:og_wallet_sdk/wallet/ethereum/common/eth_sig_util/constant/typed_data_version.dart';
import 'package:og_wallet_sdk/wallet/ethereum/common/eth_sig_util/model/ecdsa_signature.dart';
import 'package:og_wallet_sdk/wallet/ethereum/common/eth_sig_util/util/abi.dart';
import 'package:og_wallet_sdk/wallet/ethereum/common/eth_sig_util/util/signature.dart';
import 'package:og_wallet_sdk/wallet/ethereum/common/eth_sig_util/util/utils.dart';
...
class TypedDataUtil {
  static Uint8List hashMessage({
    ...
    late final dynamic rawTypedData;
    try {
    ...
    if (version == TypedDataVersion.V1) {
      ...
      late final TypedMessage typedData;
      try {
      ...
      List<dynamic> encodeField(String name, String type, dynamic value) {
        ...
        if (type == 'bytes') {
          if (value is String) {
            ...
            throw ArgumentError('Not supported type for bytes');
          }
    ...
    return AbiUtil.soliditySHA3(
      ...
      [
        AbiUtil.soliditySHA3(
          List.generate(typedData.length, (index) => 'string'),
          schema,
        ),
