...
class ERC20 extends web3.GeneratedContract {
  ...
  Future<BigInt> allowance(
    ...
    assert(checkSignature(function, 'dd62ed3e'), 'Invalid function signature');
  ...
  Future<String> approve(
    ...
    assert(checkSignature(function, '095ea7b3'), 'Invalid function signature');
  ...
  Future<BigInt> balanceOf(
    ...
    assert(checkSignature(function, '70a08231'), 'Invalid function signature');
  ...
  Future<BigInt> decimals({web3.BlockNum? atBlock}) async {
    ...
    assert(checkSignature(function, '313ce567'), 'Invalid function signature');
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  Future<String> name({web3.BlockNum? atBlock}) async {
    ...
    assert(checkSignature(function, '06fdde03'), 'Invalid function signature');
    final params = [];
    final response = await read(function, params, atBlock);
  ...
  Future<String> symbol({web3.BlockNum? atBlock}) async {
    ...
    assert(checkSignature(function, '95d89b41'), 'Invalid function signature');
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as String);
  }
  ...
  Future<BigInt> totalSupply({web3.BlockNum? atBlock}) async {
    ...
    assert(checkSignature(function, '18160ddd'), 'Invalid function signature');
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  Future<String> transfer(
    ...
    assert(checkSignature(function, 'a9059cbb'), 'Invalid function signature');
  ...
  Future<String> transferFrom(
    ...
    assert(checkSignature(function, '23b872dd'), 'Invalid function signature');
  ...
  Stream<Approval> approvalEvents({
    web3.BlockNum? fromBlock,
    web3.BlockNum? toBlock,
  }) {
